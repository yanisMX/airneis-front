...
const PresentationPage = () => {
    return (
        ...
        <div className="card-body">
            <h2 className="card-title">Kenny Tsu Yen <span><Link href="https://www.linkedin.com/in/yutsuenkenny/" target="_blank"><i className="fa-brands fa-linkedin text-2xl"/></Link></span></h2>
