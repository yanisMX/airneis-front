...
export default function CategoriesFiltersModal({ id, filters, defaultItemsPerPageLimit, setFilters, fetchCategories }: { id: string, filters: CategoryFilters, defaultItemsPerPageLimit: number, setFilters: (filters: CategoryFilters) => void, fetchCategories: () => void }) {
