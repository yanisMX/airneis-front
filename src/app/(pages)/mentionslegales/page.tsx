    ...
    <>
      ...
      <div className="content-below-navbar ">
        ...
        <p>
          ...
          octobre 1995. A l’occasion de l’utilisation du site https://airneis.fr
          peuvent êtres recueillies :<br />
          <br />
          L’URL des liens par l’intermédiaire desquels l’utilisateur a accédé au
          site https://airneis.fr, le fournisseur d’accès de l’utilisateur,
          l’adresse de protocole Internet (IP) de l’utilisateur. En tout état de
          cause la Baleine Basque ne collecte des informations personnelles
          relatives à l’utilisateur que pour le besoin de certains services
          proposés par le site https://airneis.fr. L’utilisateur fournit ces
          informations en toute connaissance de cause, notamment lorsqu’il
          procède par lui-même à leur saisie. Il est alors précisé à
          l’utilisateur du site https://airneis.fr l’obligation ou non de
          ...
          <br />
          <br />
          Pour exercer vos droits, nous vous prions de bien vouloir adresser par
          courrier votre demande, accompagnée d’une copie d’un titre d’identité
          signé, à l&apos;adresse suivante : Ceyssat 16 rue de ville
          d&apos;Avray.92310 Sèvres
          <br />
          <br />
          Aucune information personnelle de l’utilisateur du site
          https://airneis.fr n’est publiée à l’insu de l’utilisateur, échangée,
          transférée, cédée ou vendue sur un support quelconque à des tiers.
          Seule l’hypothèse du rachat de La Baleine Basque et de ses droits
          ...
          du site https://airneis.fr. Les bases de données sont protégées par
